...
RUN_NAME="qwen2p5_stage2_reasonseg_ft" # describe what your experiment is about
...
export WANDB_TAGS="qwen2p5_stage2_reasonseg" # tags for the experiment in wandb
